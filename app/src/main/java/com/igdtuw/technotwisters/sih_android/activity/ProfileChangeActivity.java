    ...
    public void submit() {
       // Log.d(TAG, "Login");
        ...
        if(name==null||age==0||contactNum==0||email==null||address==null||city==null||state==null||qualification==null||expertise==null||teachingExperience==0||preferredLocation==null){
            ...
            authenticateUser = ApiClient.getInterface().updateUserDetails(name,age,contactNum,email,expertise,address,city,state,preferredLocation,qualification,teachingExperience);
