...
import com.igdtuw.technotwisters.sih_android.fragments.AdditionalFingerprintAuthFragment;
...
//            startActivity(intent);
    ...
    private class PurchaseButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                case R.id.purchase_button:
                    ...
                    break;
                case R.id.purchase_button_not_invalidated:
        ...
        @RequiresApi(api = VERSION_CODES.M)
        public void enrollNewFingerprint() {
            initCipher(mCipher, mKeyName);
            AdditionalFingerprintAuthFragment fragment
                    = new AdditionalFingerprintAuthFragment();
            fragment.setCryptoObject(new FingerprintManager.CryptoObject(mCipher));
            fragment.setStage(
                    AdditionalFingerprintAuthFragment.Stage.NEW_FINGERPRINT_ENROLLED);
        ...
        public void fingerprintValidation() {
            if (initCipher(mCipher, mKeyName)) {
                ...
                if (useFingerprintPreference) {
                    fragment.setStage(
                            AdditionalFingerprintAuthFragment.Stage.FINGERPRINT);
                } else {
                    fragment.setStage(
                            AdditionalFingerprintAuthFragment.Stage.PASSWORD);
                }
                fragment.show(getFragmentManager(), DIALOG_FRAGMENT_TAG);
            }
        }
